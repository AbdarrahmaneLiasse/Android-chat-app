...
public class chat_person extends AppCompatActivity
{
    ...
    void x()
    {
        ...
        db.collection("AL").document("person").collection(chatwith_username)
                .get()
    ...
    private void SendMessage()
    {
       ...
       // message_textview.setText(message);
        ...
        else
        {
            ...
            db.collection("AL").document("person").collection(chatwith_username).document(String.valueOf(System.currentTimeMillis())).set(msg).addOnSuccessListener(new OnSuccessListener<Void>()
                    {
